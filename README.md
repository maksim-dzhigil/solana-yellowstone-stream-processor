...
- Live `/status` and `/metrics` expose producer state, reconnect attempts, last reconnect delay, last safe error summary, last observed event time, last persisted batch time, and seconds-since staleness gauges.
